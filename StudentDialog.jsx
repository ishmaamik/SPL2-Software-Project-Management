...
const StudentDialog= ({open, SetOpen})=>
{
...
const ErrorClose=()=>
{
   ...
   {
    try{
    let response= await authenticateStudentLogin(login);
    ...
    return(
        <Dialog open={open} onClose={()=> ErrorClose(SetOpen, setErrorz)} PaperProps={{sx:dialogStyle}} hideBackdrop={false}>
         <Wrapper>
            ...
            { errorz && <Errorz>Please enter valid Student ID or Password</Errorz> }
